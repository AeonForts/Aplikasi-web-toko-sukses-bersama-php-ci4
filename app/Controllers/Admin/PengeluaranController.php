...
class PengeluaranController extends BaseController
{
        ...
        $response = [
            ...
            'data' => array_map(function($item) {
                return [
                    ...
                    'action' => '<a href="' . base_url('admin/pengeluaran/detail/' . $item['id_pengeluaran']) . '" class="btn btn-info text-white">Detail</a>'
                ];
            }, $data)
        ];
    ...
    public function detail($id)
    {
        ...
        return view('pages/admin/pengeluaran/detail', $data);
    }
