...
class PenjualanController extends BaseController
{
    ...
    public function list()
    {
        ...
        return view('pages/petugas/penjualan/list', $data);
    }
        ...
        $response = [
            ...
            'data' => array_map(function($item) {
                return [
                    ...
                    'action' => '<a href="' . base_url('petugas/penjualan/detail/' . $item['id_penjualan']) . '" class="btn btn-info text-white">Detail</a>'
                ];
            }, $data)
        ];
    ...
    public function detail($id)
    {
        ...
        return view('pages/petugas/penjualan/detail', $data);
    }
...
'storeAddress' => 'Jl. Rambutan Raya No. 42<br>RT.06/RW.06 Baranangsiang<br>Kec. Bogor Timur, Kota Bogor<br>Jawa Barat 16143',                    'phone' => '082175671616',
    ...
    public function printInvoice($invoiceId)
    {
        try {
            ...
            $receiptHtml = view('pages/petugas/penjualan/invoice_receipt', $receiptData);
