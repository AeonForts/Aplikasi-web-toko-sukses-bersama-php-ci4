...
<div class="col-12">
    <a href="#" onclick="window.location.href='<?= base_url('petugas/penjualan'); ?>'; return false;" class="btn btn-primary">
    ...
    $('.mark-lunas').on('click', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '<?= base_url('petugas/penjualan/mark-lunas'); ?>',
                    type: 'POST',
                    dataType: 'json',
                    data: {
...
function deleteDetailPenjualan(idDetailPenjualan) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: '<?= base_url('petugas/penjualan/delete-detail'); ?>', 
                type: 'POST',
                dataType: 'json',
                data: {
                    id_detail_penjualan: idDetailPenjualan
