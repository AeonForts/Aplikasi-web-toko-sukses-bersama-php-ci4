...
$(document).ready(function() {
    var table = $('#invoiceTable').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: '<?= base_url('admin/invoice/datatables'); ?>',
            type: 'POST',
            data: function(d) {
                ...
                render: function(data) {
                    return `
                        <div class="btn-group" role="group">
                            <a href="<?= base_url('admin/invoice/detail/') ?>${data}" class="btn btn-info btn-sm">
                                <i class="fa fa-eye"></i> Detail
                            </a>
                            <button onclick="printInvoice(${data})" class="btn btn-success btn-sm">
                                <i class="fa fa-print"></i> Print
                            </button>
                            <button onclick="deleteInvoice(${data})" class="btn btn-danger btn-sm">
...
function printInvoice(invoiceId) {
    $.ajax({
        url: '<?= base_url('admin/invoice/print/') ?>' + invoiceId, // Corrected route
        method: 'GET',
        dataType: 'json',
