...
$(document).ready(function() {
    ...
    $('#pengeluaranTambahForm').on('submit', function(event) {
        ...
        $.ajax({
            url: '<?= base_url('admin/pengeluaran/save'); ?>',
            type: 'POST',
            data: $(this).serialize(),
    ...
    $('.edit-btn').on('click', function() {
        ...
        $.ajax({
            url: '<?= base_url('admin/pengeluaran/edit'); ?>',
            type: 'POST',
    ...
    $('#pengeluaranEditForm').on('submit', function(event) {
        event.preventDefault();
        $.ajax({
            url: '<?= base_url('admin/pengeluaran/update'); ?>',
            type: 'POST',
            data: $(this).serialize(),
            success: function(response) {
...
$('.delete-btn').on('click', function() {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: '<?= base_url('admin/pengeluaran/delete'); ?>',
                type: 'POST',
                data: { id_detail_pengeluaran: id },
                success: function(response) {
...
function fetchChartData() {
    $.ajax({
        url: '<?= base_url('admin/pengeluaran/chart-data'); ?>',
        method: 'GET',
