...
<div class="col-12">
    <a href="#" onclick="window.location.href='<?= base_url('admin/pengeluaran'); ?>'; return false;" class="btn btn-primary">
...
<?= view('pages/admin/pengeluaran/modal') ?> <!-- Modal view for edit functionality -->
