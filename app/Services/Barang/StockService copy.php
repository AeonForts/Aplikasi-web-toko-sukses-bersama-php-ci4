   ...
   /**
    ...
    public function updateStockWithSpecificDate($input)
    {
        ...
        try {
            ...
            // Recalculate stock for subsequent dates
    ...
    private function recalculateSubsequentStock($id_tipe, $startDate)
    {
        ...
        $currentStock = $previousStock ? $previousStock['stock_barang'] : 0;

        foreach ($subsequentStocks as $stock) {
            $currentStock += $stock['barang_masuk'] - $stock['barang_keluar'];
